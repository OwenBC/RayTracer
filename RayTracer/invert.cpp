...
void invert_matrix(std::vector<std::vector<double>>& A, std::vector<std::vector<double>>& Ainv);
void adjoint(std::vector<std::vector<double>>& in, std::vector<std::vector<double>>& out);
double det4x4(std::vector<std::vector<double>>& m);
